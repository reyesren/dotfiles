...
# Custom color for commands
ZSH_HIGHLIGHT_STYLES[command]='fg=10'           # or 'fg=green'
ZSH_HIGHLIGHT_STYLES[builtin]='fg=10'           # cd, echo, etc.
ZSH_HIGHLIGHT_STYLES[reserved-word]='fg=magenta'  # if, then, else
ZSH_HIGHLIGHT_STYLES[alias]='fg=10'

# Optional: highlight unknown commands
